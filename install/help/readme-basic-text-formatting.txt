README --> Basic Text Formatting

The following three points will cover most of your writing needs, though there are many more features available. See the @[cheat-sheet] for a handy reference.

=[Firstly], you'll need to know how to lay out text. A single character at the start of a line or a paragraph tells you what it is, like how `>` indicates a quotation in email.
...
From this we can see that `+` and `-` are large and small headings, `>` and `=` are quotes and captions, and `*` are bullet points. See @[four-kinds-of-text-blocks], for a full list of control characters.
