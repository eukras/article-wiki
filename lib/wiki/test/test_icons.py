...
def test_icons():
    ...
    pairs = [
        ["okay :y okay",
         "okay <i class=\"fa fa-check\"></i> okay"],
        ["okay :n okay",
         "okay <i class=\"fa fa-cross\"></i> okay"],
        ["okay :book okay",
         "okay <i class=\"fa fa-book\"></i> okay"],
        ["okay :! okay",
        ...
        [":book okay",
         "<i class=\"fa fa-book\"></i> okay"],
        ["okay :y",
         "okay <i class=\"fa fa-check\"></i>"],
        ["okay :book",
         "okay <i class=\"fa fa-book\"></i>"],
    ]
