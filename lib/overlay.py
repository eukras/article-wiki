...
def make_overlay(image, layout):
    ...
    for frame in layout['frames']:
        ...
        for number, text in enumerate(frame['texts']):
            ...
            text_opts = ChainMap(text, frame, layout,
                                 DEFAULT_TEXT, DEFAULT_FRAME, DEFAULT_LAYOUT)
...
def make_byline(image: Image, font: ImageFont, byline: str,
                color: tuple):
    """
